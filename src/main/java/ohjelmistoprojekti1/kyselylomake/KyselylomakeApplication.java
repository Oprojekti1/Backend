...
public class KyselylomakeApplication {
	...
	public CommandLineRunner demo(KysymysRepository krepository, VastausRepository vastausRepository,
		...
		return (args) -> {
			...
			// luodaan pari kysymystä joista ensimmäisen tyyppi on radiobutton ja toisen
			// avoin vastauskenttä ja tallennetaan ne kysymys repositorioon
			...
			Vastaus v4 = new Vastaus("Höhöhööhöh", k2);
			...
			// luodaan uusia vastausvaihtoehtoja kysymykselle k1 joka on tyypiltään
			// radiobutton
			...
			// loggausrivejä bugien metsästykseen. jokainen nippu loggaa yksittäisen
			// repositorion sisällön
