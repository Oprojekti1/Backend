...
public class WebSecurityKyselylomake extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/styles/**").permitAll() // css käyttö
				...
				.authorizeRequests().antMatchers("/auth/*").hasAnyAuthority("ADMIN") 
																					
				// Määritetty kellä on oikeus /auth/* endpointtiin
				.and().formLogin().loginPage("/login").defaultSuccessUrl("/auth/kysely", true).permitAll().and()
